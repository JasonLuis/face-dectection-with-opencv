...
for (x,y,l,a) in facesDetectadas:
  imagem = cv2.rectangle(imagem, (x,y), (x+l,y+a), (255,255,0),2)
  regiao = imagem[y:y + a, x:x + l]
  regiaoCinzaOlho = cv2.cvtColor(regiao, cv2.COLOR_BGR2GRAY)
  olhosDetectados = classificadorOlhos.detectMultiScale(regiaoCinzaOlho, scaleFactor=1.08,minNeighbors=3,)
